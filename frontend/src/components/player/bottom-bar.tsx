...
export function BottomBar({
  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 rounded-2xl border border-white/8 bg-linear-to-b from-white/4 to-transparent px-4 py-2">
      <FooterToggle
        label="METRÓNOMO"
        active={metronomeOn}
