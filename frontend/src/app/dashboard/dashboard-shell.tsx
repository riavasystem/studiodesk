...
export function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-svh flex-1 flex-col overflow-hidden bg-background">
      <header className="flex shrink-0 items-center justify-between border-b border-white/10 px-6 py-2 md:px-10">
      ...
      <main className="flex-1 overflow-y-auto px-6 py-3 md:px-10">{children}</main>
    </div>
  );
}
